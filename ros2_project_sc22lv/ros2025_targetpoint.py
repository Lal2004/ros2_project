...
#             (-9.5, -14.5, 0.0),
#             (2.3, -10.0, 0.0),
#             # above coordinate was purposely set to show accessor the all 3 box color detection as there are alot of coordinates
#             # ** (2.3, -10.0, 0.0) is not a corner coordinate
#             (-11.0, 3.7, 0.0),
#             (-3.2, 3.4, 0.0),
#             (-1.5, -3.1, 0.0),
#             (-1.6, 4.7, 0.0),
...
#     #                 spin_duration = 2.0
#     #                 start_time = self.get_clock(540).now()
